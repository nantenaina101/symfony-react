...
class EtudiantController extends AbstractController
{
    ...
    public function getEtudiantList(EtudiantRepository $etudiantRepository, SerializerInterface $serializer): JsonResponse
    {
    ...
    #[Route('/etudiant/delete/{id}', name: 'app_delete_etudiant', methods: ['DELETE'])]
    public function deleteEtudiant(Etudiant $etudiant): JsonResponse
    {
    ...
    #[Route('/etudiant/add/new', name: "app_create_etudiant", methods: ['POST'])]
    public function addEtudiant(Request $request, SerializerInterface $serializer): JsonResponse
    {
